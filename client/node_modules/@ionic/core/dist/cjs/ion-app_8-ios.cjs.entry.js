    ...
    componentDidLoad() {
        {
            helpers.rIC(() => {
                ...
                if (config.config.getBoolean('statusTap', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./status-tap-25c1f988.js')); }).then(module => module.startStatusTap());
                }
                if (config.config.getBoolean('inputShims', needInputShims())) {
                    new Promise(function (resolve) { resolve(require('./input-shims-31a174c4.js')); }).then(module => module.startInputShims(config.config));
                }
...
const Content = class {
    ...
    render() {
        ...
        this.resize();
        return (core.h(core.Host, { class: Object.assign({}, theme.createColorClasses(this.color), { [mode]: true, 'content-sizing': theme.hostContext('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-76782bf3.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
