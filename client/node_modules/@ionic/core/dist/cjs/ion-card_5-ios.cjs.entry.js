...
const Card = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign({ [mode]: true }, theme.createColorClasses(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    }
...
const CardHeader = class {
    ...
    render() {
        const mode = core.getIonMode(this);
        return (core.h(core.Host, { class: Object.assign({}, theme.createColorClasses(this.color), { 'card-header-translucent': this.translucent, [mode]: true }) }, core.h("slot", null)));
    }
...
const CardTitle = class {
    ...
    render() {
        const mode = core.getIonMode(this);
        return (core.h(core.Host, { role: "heading", "aria-level": "2", class: Object.assign({}, theme.createColorClasses(this.color), { [mode]: true }) }, core.h("slot", null)));
    }
