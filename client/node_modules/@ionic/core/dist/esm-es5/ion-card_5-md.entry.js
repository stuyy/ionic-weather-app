import { r as registerInstance, h, d as getIonMode, H as Host } from './core-5ba38749.js';
...
var Card = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { class: Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    };
...
var CardHeader = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        var _a;
        var mode = getIonMode(this);
        return (h(Host, { class: Object.assign({}, createColorClasses(this.color), (_a = { 'card-header-translucent': this.translucent }, _a[mode] = true, _a)) }, h("slot", null)));
    };
...
var CardTitle = /** @class */ (function () {
    ...
    class_5.prototype.render = function () {
        var _a;
        var mode = getIonMode(this);
        return (h(Host, { role: "heading", "aria-level": "2", class: Object.assign({}, createColorClasses(this.color), (_a = {}, _a[mode] = true, _a)) }, h("slot", null)));
    };
