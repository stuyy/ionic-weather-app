    ...
    class_1.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-9a052aee.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-7b87c414.js').then(function (module) { return module.startInputShims(config); });
                }
...
var Content = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        ...
        this.resize();
        return (h(Host, { class: Object.assign({}, createColorClasses(this.color), (_a = {}, _a[mode] = true, _a['content-sizing'] = hostContext('ion-popover', this.el), _a['overscroll'] = forceOverscroll, _a)), style: {
