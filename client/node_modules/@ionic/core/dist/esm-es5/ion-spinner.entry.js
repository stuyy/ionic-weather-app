...
var Spinner = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { class: Object.assign({}, createColorClasses(self.color), (_a = {}, _a[mode] = true, _a["spinner-" + spinnerName] = true, _a['spinner-paused'] = !!self.paused || config.getBoolean('_testing'), _a)), role: "progressbar", style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} }, svgs));
    };
