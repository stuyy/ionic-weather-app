...
var Chip = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { class: Object.assign({}, createColorClasses(this.color), (_a = {}, _a[mode] = true, _a['chip-outline'] = this.outline, _a['ion-activatable'] = true, _a)) }, h("slot", null), mode === 'md' && h("ion-ripple-effect", null)));
    };
